...
*/
public class ButtonBoldLight extends Button {
private Typeface tf = null;
private String customFont;
public ButtonBoldLight(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);
    setCustomFontTextView(context, attrs);
}

public ButtonBoldLight(Context context, AttributeSet attrs) {
    super(context, attrs);
    setCustomFontTextView(context, attrs);
}

public ButtonBoldLight(Context context) {
    super(context);
