 ...
 */
public class EditTextHelvetica extends EditText implements TextWatcher {
    ...
    public boolean setCustomFontEdittext(Context ctx, String asset) {
        try {
            tf = Typeface.createFromAsset(ctx.getAssets(), "helvetica.ttf");
//            tf = Typeface.createFromAsset (ctx.getAssets (), "museo700.ttf");
    ...
    public boolean setCustomFontEdittextHint(Context ctx, String asset) {
        try {
            tfhint = Typeface.createFromAsset(ctx.getAssets(), "helvetica.ttf");
