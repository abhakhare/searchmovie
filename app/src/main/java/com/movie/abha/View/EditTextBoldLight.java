 ...
 */
public class EditTextBoldLight extends EditText implements TextWatcher {
    ...
    public EditTextBoldLight(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        // initViews();
    }

    public EditTextBoldLight(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
        // initViews();
    ...
    public EditTextBoldLight(Context context, AttributeSet attrs, int defStyle) {
